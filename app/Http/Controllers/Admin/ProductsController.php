...
class ProductsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            $products = Product::where('restaurant_id', 'LIKE', "%$keyword%")
    ...
    public function create()
    {
        ...
        return view('admin.products.create', ['restaurants' => $restaurants]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.products.edit', ['product' => $product, 'restaurants' => $restaurants]);
    }
